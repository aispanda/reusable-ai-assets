...
**Writing craft:** When creating or refining any principle row—or other site prose—the compressed line may stay elevated; the rule, practical test and example must stay plain and concrete. Asset maintainers may consult the relevant writing-craft asset before scaffolding, but generated project documents must remain self-contained.
