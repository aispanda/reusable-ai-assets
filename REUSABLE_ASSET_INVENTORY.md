...
| RA-002 | Cloud deployment | Deployment Automation | GCP, Cloud Build, Cloud Run, isolated staging, exact-image promotion, preflight, approval gate, verification, **custom domain mapping (zero-cost)** | [`Deployment Automation/ASSET.md`](Deployment%20Automation/ASSET.md) | Reusable; staged promotion and domain mapping | 2026-09-26 |
...
| RA-005 | Consulting delivery / project governance | AI-Native Rapid Solution Delivery Kit | any application, digital product, platform, data, automation or AI initiative; seed capture (raw as-spoken); brand-voice identity flow Q1–Q16 (mission/vision/onlyness/voice/emotion gaps); vibe→principles/brand feeling; engineering principles brain (intent/direction operating model + 9 Sutras), prose via RA-006 writing-craft, evidence matrix, discovery, roadmap, decisions, design, build readiness, cross-IDE/agent handover | [`AI-Native Rapid Solution Delivery Kit/ASSET.md`](AI-Native%20Rapid%20Solution%20Delivery%20Kit/ASSET.md) | Pilot-ready v0.16; writing via RA-006 writing-craft; strategy→expression elicitation; evaluation pending | 2026-08-08 |
...
| RA-009 | Interface delivery / quality evidence | Interface State Evidence System | component catalog, state contract, deterministic fixture, visual evidence, interaction evidence, accessibility review, master-plus-adapter adoption | [`Interface State Evidence System/ASSET.md`](Interface%20State%20Evidence%20System/ASSET.md) | Draft — implementation starter; cross-project evaluation pending | Not verified |
