...
| RA-010 | Delivery governance / quality assurance | Lean Decision Review Cell | bounded review, product outcome, UI/UX, accessibility, evidence, risk, human decision | [`Lean Decision Review Cell/ASSET.md`](Lean%20Decision%20Review%20Cell/ASSET.md) | Draft — structurally validated; three application evaluations pending | 2026-08-18 |
